...
setElementVisibleTo(swtData["deliverMarker1"],getRootElement(), false)
setElementVisibleTo(swtData["deliverBlip1"],getRootElement(), false)
setElementVisibleTo(swtData["deliverMarker2"],getRootElement(), false)
setElementVisibleTo(swtData["deliverBlip2"],getRootElement(), false)
